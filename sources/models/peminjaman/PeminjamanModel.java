...
public class PeminjamanModel extends BaseModel {
	...
	public PeminjamanModel(int idRuangan, int idPengguna, String namaPeminjam, LocalDateTime waktuMulai, LocalDateTime waktuSelesai, String keterangan, StatusEnum status) {
		super(-1);
	...
	public PeminjamanModel(int id, int idRuangan, int idPengguna, String namaPeminjam, LocalDateTime waktuMulai, LocalDateTime waktuSelesai, String keterangan, StatusEnum status, Timestamp dibuat) {
		super(id);
